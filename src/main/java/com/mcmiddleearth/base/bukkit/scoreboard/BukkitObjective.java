...
public class BukkitObjective implements Objective {
    ...
    private final org.bukkit.scoreboard.Objective bukkitObjective;

    public BukkitObjective(org.bukkit.scoreboard.Objective bukkitObjective) {
        this.bukkitObjective = bukkitObjective;
    }
